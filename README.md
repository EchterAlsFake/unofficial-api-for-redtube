...
<p align="center"><em>An asynchronous Python API wrapper and scraper for redtube.com</em></p>

<div align="center">
    <a href="https://pepy.tech/project/redtube_api"><img src="https://static.pepy.tech/badge/redtube_api" alt="Downloads"></a> +
    <a href="https://pepy.tech/project/unofficial-api-for-redtube"><img src="https://static.pepy.tech/badge/unofficial-api-for-redtube" alt="Downloads"></a>
    <a href="https://badge.fury.io/py/unofficial-api-for-redtube"><img src="https://badge.fury.io/py/unofficial-api-for-redtube.svg" alt="PyPI version" height="18"></a>
    <a href="https://echteralsfake.me/ci/unofficial-api-for-redtube/badge.svg"><img src="https://echteralsfake.me/ci/unofficial-api-for-redtube/badge.svg" alt="API Tests"/></a>
    </div>
...
| Category | Details |
|---|---|
| **Video Fetching** | Fetch video objects with full metadata (title, views, quality, publish date, author, description, tags) |
| **Video Downloading** | HLS-based downloading with configurable quality (`best`, `half`, `worst`, or specific resolutions) |
| **Playlist Fetching** | Fetch playlist details, playlist author, and playlist videos |
| **User Profiles** | Fetch user profile details, uploaded videos, and playlists |
...
### Have a look at the [Documentation](https://docs.echteralsfake.me/redtube) for more details

```python
import asyncio
from redtube_api import Client, DownloadConfigHLS
