...
from redtube_api.api import create_parser, run_main
...
class TestCLI(unittest.IsolatedAsyncioTestCase):
    ...
    def test_parser_custom_args(self):
        ...
        args = parser.parse_args([
            "--download", "https://redtube.com/12345",
            "--output", "/tmp/out",
            "--quality", "worst",
            "--no-title", "True"
        ])
        self.assertEqual(args.download, "https://redtube.com/12345")
        self.assertEqual(args.output, "/tmp/out")
    ...
    async def test_run_main_download(self):
        ...
        with patch("redtube_api.api.Client", return_value=mock_client):
            await run_main(["--download", "https://redtube.com/12345", "--output", "/tmp/out"])

        mock_client.get_video.assert_awaited_once_with("https://redtube.com/12345", load_html=True)
